      ...
      <PerfectScrollbar options={{ suppressScrollX: true }}>
        ...
        >
          ...
          <small className="text-muted">
            ...
            <ul>
              <li>
                첫번째 주간 알고리즘 기한내 PR 제출 (기한 초과시 250)
              </li>
              <li>
                첫번째 주간 알고리즘 기한내 풀이 포스팅 (기한 초과시 250)
              </li>
              <li>
                두번째 주간 알고리즘 기한내 PR 제출 (기한 초과시 250)
              </li>
              <li>
                두번째 주간 알고리즘 기한내 풀이 포스팅 (기한 초과시 250)
              </li>
              <li>
            ...
            <ul>
              ...
              <li>
                <s>두번째 주간 알고리즘 베스트 숏 코드</s>
              </li>
              <li>
                월간 포스팅 합산 활성 건수가 가장 높은 멤버, 건수 동일시에는 활성일 수가 낮은(빠른 작성) 맴버
              </li>
              <li>
                월간 토이 프로젝트 PR 제출 또는 Issue 등록 건수가 가장 높은 멤버(zeroradish 제외)
              </li>
            </ul>
            <br />
            <s>
