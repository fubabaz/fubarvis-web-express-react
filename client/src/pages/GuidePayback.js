      ...
      <PerfectScrollbar options={{ suppressScrollX: true }}>
        ...
        >
          ...
          <small className="text-muted">
            ...
            <br />
            <br />
            <strong className="text-black">6개 항목별  <mark>500원</mark></strong>
            <br />
            <ul>
              <li>
                첫번째 주간 알고리즘 기한내 PR 제출<small> - 기한 초과 제출시 250</small>
              </li>
              <li>
                첫번째 주간 알고리즘 기한내 풀이 포스팅<small> - 기한 초과 제출시 250</small>
              </li>
              <li>
                두번째 주간 알고리즘 기한내 PR 제출<small> - 기한 초과 제출시 250</small>
              </li>
              <li>
                두번째 주간 알고리즘 기한내 풀이 포스팅<small> - 기한 초과 제출시 250</small>
              </li>
              <li>
            ...
            <strong className="text-black">
              10개 항목별  <mark>125원 * N(참여맴버수)</mark>
            </strong>
            <br />
            <ul>
              <li>
                첫번째 주간 알고리즘 문제 제출자<small> - 자유알고리즘 활동</small>
              </li>
              <li>
                첫번째 주간 알고리즘 베스트 메모리<small> - 주간알고리즘 활동</small>
              </li>
              <li>
                첫번째 주간 알고리즘 베스트 실행시간<small> - 주간알고리즘 활동</small>
              </li>
              <li>
                두번째 주간 알고리즘 문제 제출자<small> - 자유알고리즘 활동</small>
              </li>
              <li>
                두번째 주간 알고리즘 베스트 메모리<small> - 주간알고리즘 활동</small>
              </li>
              <li>
                두번째 주간 알고리즘 베스트 실행시간<small> - 주간알고리즘 활동</small>
              </li>
              <li>
                월간 포스팅 합산 활성 건수가 가장 높은 멤버, 건수 동일시에는 활성일 수가 낮은(빠른 작성) 맴버<small> - 월간포스팅 활동</small>
              </li>
              <li>
                월간 토이 프로젝트 PR 제출 또는 Issue 등록 건수가 가장 높은 멤버(zeroradish 제외)<small> - 토이프로젝트 활동</small>
              </li>
            </ul>
            <br />
            <s>
            ...
            <br />
            <ul>
            <li>60% 동호회 공용 자금 축적</li>
            <li>10% 첫번째 주간 알고리즘 문제 제출자</li>
            <li>10% 두번째 주간 알고리즘 문제 제출자</li>
            <li>10% 월간 포스팅 합산 활성 건수가 가장 높은 멤버, 건수 동일시에는 활성일 수가 낮은(빠른 작성) 맴버</li>
            <li>10% 월간 토이 프로젝트 PR 제출 또는 Issue 등록 건수가 가장 높은 멤버(zeroradish 제외)</li>
            </ul>
          </small>
        </div>
      </PerfectScrollbar>
